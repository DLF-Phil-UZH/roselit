...
<p>Ersteller: <?php echo $list["creator"]?></p>
<p>Administrator: <?php echo $list["admin"]?></p>
<p>Erstellt am: <?php echo $list["created"]?></p>
<p>Zuletzt ge&auml;ndert am: <?php echo $list["lastUpdated"]?></p>
<h3>Dokumente:</h3>

<?php foreach($list["documentIds"] as $lDocument): // Will not work, copied from tutorial
